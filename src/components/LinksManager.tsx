...
export default function LinksManager({
    ...
    if (readonly) {
      return (
        <a
          ...
          title={link.url}
        >
          <span className="text-primary group-hover:text-primary/80">{getBrandIcon(link.url)}</span>
  ...
  return (
    <div className={className}>
      ...
      <div className={readonly ? "flex flex-wrap gap-2" : "space-y-3"}>
        ...
        {localLinks.length === 0 && !isAdding && !readonly && (
